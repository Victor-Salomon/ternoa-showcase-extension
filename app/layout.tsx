          ...
          <main className="container mx-auto mt-24">
            <div className="border my-10 rounded-md space-y-6 p-4 md:p-10 md:pb-16">
              ...
              <div className="text-center bg-muted px-4 py-10 rounded-md md:hidden">
                ...
                <p className="text-muted-foreground">
                  Because of the Polakdot extensions is not availble on mobile,
                  this application is meant to be used on desktop only. Please
                  open it on your desktop to enjoy the full experience.
                </p>
              </div>
